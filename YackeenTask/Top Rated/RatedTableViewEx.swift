...
extension RatedVC: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vcFav = nextStoryboard.instantiateViewController(withIdentifier: "FavVC") as! FavVC
